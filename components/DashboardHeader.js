    ...
    <DashboardHeader style={{ paddingBottom: '100px' }}>
      <Columns>
        <Column width={6}>
          ...
          <p>This is an example AdminBro dashboard.</p>
          <p>
            It is dynamically built based on your database schema. On the
            sidebar you can see different types of resources. Some are{' '}
            <a href="https://softwarebrothers.github.io/admin-bro-dev/module-admin-bro-mongoose.html">
              mongoose{' '}
            </a>
            and some are
            <a href="https://softwarebrothers.github.io/admin-bro-dev/module-admin-bro-sequelizejs.html">
              {' '}
              sequelize
            </a>
            .
